...
module TOP_DP(
    ...
    output reg [15:0] data_out, // DP to fnd
    ...
    DHT11_dp U_DHT11_dp(
        ...
        .reset(reset),
        .dht_done(dht_done),
        .sw_tem_hum({sw_mode[4:3], sw_mode[2]}),
        .data_in(data_in), // DHT11_cu input
        .DHT11_decimal_data(DHT11_decimal_data), // fnd output
        .data_out(data_out), // fnd input
        .wr_tx(wr_tx_DHT11),
